...
final class YANXINNA_Headless_Content {
	...
	public static function register() {
		register_post_type(
			...
			array(
				'labels'              => array(
					'name'          => __( 'Products', 'yanxinna-headless-products' ),
					'singular_name' => __( 'Product', 'yanxinna-headless-products' ),
					'add_new_item'  => __( 'Add Product', 'yanxinna-headless-products' ),
					'edit_item'     => __( 'Edit Product', 'yanxinna-headless-products' ),
					'view_item'     => __( 'View Product', 'yanxinna-headless-products' ),
					'search_items'  => __( 'Search Products', 'yanxinna-headless-products' ),
					'not_found'     => __( 'No products found.', 'yanxinna-headless-products' ),
				),
				'public'              => true,
		...
		register_taxonomy(
			...
			array(
				'labels'            => array(
					'name'          => __( 'Product Categories', 'yanxinna-headless-products' ),
					'singular_name' => __( 'Product Category', 'yanxinna-headless-products' ),
				),
				'public'            => true,
				'publicly_queryable' => false,
				'hierarchical'      => true,
