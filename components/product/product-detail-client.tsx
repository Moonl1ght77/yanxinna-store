    ...
    <div className="mx-auto max-w-7xl px-4 py-8 md:px-8">
      ...
      <div className="grid gap-8 md:grid-cols-[1.1fr,0.9fr]">
        ...
        <div className="border border-borderSoft bg-white p-6 md:p-8">
          ...
          <div className="mt-8">
            <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-[#8a8077]">Color</p>
          ...
          <div className="mt-8">
            <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-[#8a8077]">Size</p>
            <div className="mt-3 flex flex-wrap gap-3">
          ...
          <div className="mt-8 flex items-center justify-between border border-borderSoft bg-[#faf8f5] p-4">
            <div>
              <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-[#8a8077]">Quantity</p>
              <p className="mt-1 text-sm text-[#524a43]">Adjust before adding to cart.</p>
            </div>
          ...
          <div className="mt-10 border border-borderSoft bg-[#f7f6f4] p-5">
            <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-[#8a8077]">Compression Level</p>
          ...
          <div className="mt-8 grid gap-4 border-t border-borderSoft pt-8 text-sm leading-7 text-[#6b635d]">
            <div className="flex items-start justify-between gap-4 border-b border-borderSoft pb-4">
              <span className="text-[11px] font-medium uppercase tracking-[0.2em] text-[#8a8077]">Shipping</span>
              <span className="max-w-[70%] text-right">Free shipping over $120. Mock fulfillment and tracking flow ready for later integration.</span>
            </div>
            <div className="flex items-start justify-between gap-4 border-b border-borderSoft pb-4">
              <span className="text-[11px] font-medium uppercase tracking-[0.2em] text-[#8a8077]">Returns</span>
              <span className="max-w-[70%] text-right">Returns accepted within 30 days on unworn items with original tags attached.</span>
            </div>
          </div>

          <div className="mt-8 grid gap-6 border-t border-borderSoft pt-8">
            <div>
              <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-[#8a8077]">Series</p>
              <p className="mt-2 text-sm leading-7 text-[#6b635d]">{product.shortDescription}</p>
            </div>
            <div>
              <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-[#8a8077]">Material / Care</p>
