...
import { navigationItems, shapewearDropdownItems } from "@/lib/data/categories";
          ...
          {navigationItems.map((item) =>
            item.label === "Shapewear" ? (
              <div key={item.label} className="group relative">
                <Link
                  ...
                  className={`flex items-center gap-1 transition ${
                    isHome ? "hover:text-[#5f5852]" : "hover:text-[#231f1b]"
                  }`}
                >
                  {item.label}
              ...
              <Link
                key={item.label}
                href={item.href}
                className={`transition ${isHome ? "hover:text-[#5f5852]" : "hover:text-[#231f1b]"}`}
              >
                {item.label}
              </Link>
            )
