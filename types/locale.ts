...
export type CopyKeys = {
  ...
  appHeroTitle: string;
  appHeroSubtitle: string;
  appHeroCta: string;
  appCompetencyTitle: string;
  appCompetencySubtitle: string;
  appTech1Name: string;
  appTech1Tag: string;
  appTech1Desc: string;
  appTech1Adv: string;
  ...
  appTech3Desc: string;
  appTech3Adv: string;
  appMatrixTitle: string;
  appMatrixSubtitle: string;
  appTier1Title: string;
  appTier1Desc: string;
  appTier2Title: string;
  appTier2Desc: string;
  appTier2Items: readonly string[];
  appCapacityTitle: string;
  appCapacitySubtitle: string;
  appStatYears: string;
  appStatPatents: string;
  appStatOutput: string;
  appStatMarkets: string;
  appQualityTitle: string;
  appQualitySubtitle: string;
  appQuality1Name: string;
  appQuality1Tag: string;
  appQuality1Desc: string;
  appQuality2Name: string;
  appQuality2Tag: string;
  appQuality2Desc: string;
  appQuality3Name: string;
  appQuality3Tag: string;
  appQuality3Desc: string;
  appQuality4Name: string;
  appQuality4Tag: string;
  appQuality4Desc: string;
  appCtaTitle: string;
  appCtaBody: string;
