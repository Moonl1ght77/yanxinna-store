...
export type CopyKeys = {
  ...
  mfgHeroTitle: string;
  mfgHeroSubtitle: string;
  mfgFacilityTitle: string;
  mfgFacilitySubtitle: string;
  mfgFacility1Title: string;
  mfgFacility1Desc: string;
  mfgFacility2Title: string;
  mfgFacility2Desc: string;
  mfgFacility3Title: string;
  mfgFacility3Desc: string;
  mfgFacility4Title: string;
  mfgFacility4Desc: string;
  mfgProcessTitle: string;
  mfgProcessSubtitle: string;
  mfgProcess1Title: string;
  mfgProcess1Desc: string;
  mfgProcess2Title: string;
  mfgProcess2Desc: string;
  mfgProcess3Title: string;
  mfgProcess3Desc: string;
  mfgStatYears: string;
  mfgStatPatents: string;
  mfgStatOutput: string;
  mfgStatMarkets: string;
  mfgQcTitle: string;
  mfgQcSubtitle: string;
  mfgQcSteps: readonly string[];
  mfgCtaTitle: string;
  mfgCtaBody: string;
